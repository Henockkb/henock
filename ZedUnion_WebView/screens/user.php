...
<div class="container">
    ...
    <form method="POST" id="loginForm">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control" id="telephone" name="telephone" value="<?php echo isset($_GET['telephone']) ? htmlspecialchars($_GET['telephone']) : ''; ?>">
            </div>
        </div>
        <div class="form-group">
    ...
    <p style="color: black; text-align: center;">Vous n'avez pas de compte ? <a href="signup.php">Inscrivez-vous</a></p>
    <?php if (isset($error)) : ?>
